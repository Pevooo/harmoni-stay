...
namespace MainProject.Migrations
{
    ...
    [Migration("20231222103204_EventTransaction")]
            ...
            modelBuilder.Entity("MainProject.Models.Event", b =>
                {
                    ...
                    b.Property<int?>("EventTransactionTransactionID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EventTransactionTransactionID");
            ...
            modelBuilder.Entity("MainProject.Models.Event", b =>
                {
                    ...
                    b.HasOne("MainProject.Models.Transaction", "EventTransaction")
                        .WithMany()
                        .HasForeignKey("EventTransactionTransactionID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("EventFacility");

                    b.Navigation("EventTransaction");
                });
