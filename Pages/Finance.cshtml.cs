...
<h1 text-align: center> Financial Report </h1>
<h4 text-align: center> {DateTime.Now} </h4>
<table style="width: 100%; border-collapse: collapse; margin-top: 20px; border: 2px solid #cccccc;">
    <thead style="background-color: #cccccc">
        <th style="border: 1px; text-align: center; padding: 6px;">Query</th> 
        <th style="border: 1px; text-align: center; padding: 6px;">Value</th>
    </thead>
""";
...
<tbody>
    <tr text-align: center>
        <td style="border: 1px; text-align: center; padding: 6px">{query.Key}</td>
        <td style="border: 1px; text-align: center; padding: 6px">{query.Value}</td>
    </tr>
""";
            }
            html += $"""
