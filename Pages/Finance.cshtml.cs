...
namespace MainProject.Pages
{
    public class FinanceModel : PageModel
    {
		...
		public Dictionary<string, double> TopRoomIncome { get; set; }
        ...
        public void OnGet()
        {
			...
			try
			{
				...
				//top income
				//room
				TopRoomIncome = db.Transactions.Where(t => t.TransactionTime.Year == DateTime.Now.Year).OrderByDescending(t => t.TransactionFee).Take(5).ToDictionary(t => $"Room {t.TransactionRoom}", t => t.TransactionFee);
